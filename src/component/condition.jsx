...
const Conditions = () => {
  return (
    <div className="text-black lg:p-16 p-8">
      ...
      <ol type="1" className=" list-decimal space-y-4 text-sm">
        <li>
        ...
        <li>
          ...
          <a href="https://auradevops.com" className="text-blue-600 underline">
            https://auradevops.com
          </a>{" "}
        ...
        <li>
          ...
          <span className="font-bold">Auradevops International</span>, Purulia,
          India, a company incorporated under the Companies Act, 1956, with its
          registered office at{" "}
          <span className="font-bold">
            Holding No 741, Ward 20, Kadamkuli ,Purulia, India
          </span>{" "}
        ...
        <li>
          ...
          including the policies, constitute your binding obligations, with the
          Platform Owner. 5. 6. 7. Your use of the Platform and services and
        ...
        <ol className="list-decimal ml-6 space-y-2" start="1">
          <li>
          ...
          <li>
            ...
            <span className="font-bold">Purulia and West Bengal .</span>
          </li>
          <li>
