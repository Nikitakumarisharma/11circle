...
const PrivacyandPolicy = () => {
  return (
    <div className="text-black lg:p-16 p-8 ">
      <h1 className="text-3xl font-bold mb-4 text-blue-700">Privacy Policy</h1>
      <ol className=" list-disc space-y-4 text-sm">
        <li>
          <span className="font-bold mr-2">Introduction: </span>
          This Privacy Policy describes how Auradevops International Auradevops
          International and its affiliates (collectively " , we, our, us")
          collect, use, share, protect or otherwise process your information/
          personal data through our website Platform https://auradevops.com
        ...
        <li>
          <span className="font-bold mr-2">Collection: </span>We collect your
          ...
          their privacy policies prior to disclosing International any
          information. If you receive an email, a call from a person/association
          claiming to be Auradevops seeking any personal data like debit/credit
        ...
        <li>
          <span className="font-bold mr-2">Usage: </span> We use personal data
        ...
        <li>
          <span className="font-bold mr-2">Sharing: </span> We may share your
          ...
          be required for us to provide you access to our services and products
        ...
        <li>
          <span className="font-bold mr-2"> Security Precautions: </span>
        ...
        <li>
          <span className="font-bold mr-2"> Data Deletion and Retention: </span>
        ...
        <li>
          <span className="font-bold mr-2">Your Rights: </span>You may access,
          rectify, and update your personal data directly through the
          functionalities provided on the Platform.
        </li>
        <li>
          <span className="font-bold mr-2">Consent: </span>By visiting our
        ...
        <li>
          ...
          Name of the Comapny : auradevops International <br />
          Address of the Company : Holding No 741 ,Ward 20, Kadamkuli , purulia
          723101 <br />
          Contact us : +917586047606 <br />
          Phone: Time : Monday - Friday(9:00 - 18:00) <br />
        </li>
      </ol>
    </div>
  );
